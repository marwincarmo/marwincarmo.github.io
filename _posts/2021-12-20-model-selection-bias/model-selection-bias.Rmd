...
Much of the current research questions in the behavioral and social sciences are investigated using statistical models [@flora2017statistical]. A statistical model is a simplified translation of a certain reality to mathematical expressions that are thought to express its most important features. Regression analysis are vastly employed in empirical research and in many cases they are employed as causal modeling [@berk2010]. 


Resumir em 1 ou 2 parágrafos o que é
