...
sim_bias <- function(reps, p, n, SNR, b) {
  ...
  rsq <- NULL
  coefs <- cover <- tvals <- matrix(0, nrow = reps, ncol = p)
...
```{r}
purrr::pmap_dfr(list(1000, 2, 250, c(.1, .5, 1, 1.5, 2), 1), sim_bias)
